...
namespace CosGameTags
{
	...
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_DrawAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_FlickCardAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_AutoPlayAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_NewPlayerTurnAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_UseCardAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_VictoryAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_GameOverAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_GenerateCardAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_WinGameAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_ModifyStatusMaxAction);
	CROWNOFSIN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Action_ReturnCardToHandAction);
