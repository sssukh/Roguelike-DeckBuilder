...
void UTargetingComponent_SpecifiedCardsInHand::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UTargetingComponent_SpecifiedCardsInHand::TickComponent(float DeltaTime, ELevelTick TickType,
