...
void UTargetingComponent_SpecifiedCardsInPile::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UTargetingComponent_SpecifiedCardsInPile::TickComponent(float DeltaTime, ELevelTick TickType,
